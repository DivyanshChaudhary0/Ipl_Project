...
const PointsTable = () => {
  ...
  async function getPointsData() {
    ...
    try {
      ...
      setPointsData(result.pointsTable[0].pointsTableInfo)
    } catch (error) {
      console.error(error);
    }
  }
  ...
  useEffect(() => {
    // getPointsData();
    setPointsData(tableData.pointsTable[0].pointsTableInfo);
  }, []);
          ...
          >
            ...
            <span className="pr-4 flex gap-1">
              {form
                ...
                .map((data) =>
                  data === "W" ? (
                    <i className="fi fi-ss-badge-check text-green-400"></i>
                  ) : (
                    <i className="fi fi-br-octagon-xmark text-red-500"></i>
                  )
                )}
            </span>
          </div>
